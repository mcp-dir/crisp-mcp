...
Crisp segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **Crisp IM SAS** | FR | plataforma de atendimento/chat/CRM/helpdesk (provedor dos dados do usuário) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [crisp@mcp.ai](mailto:crisp@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
